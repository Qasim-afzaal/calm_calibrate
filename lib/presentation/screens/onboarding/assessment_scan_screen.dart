...
/// Camera-based mobility assessment — shown when [AiFeatures.cameraScanEnabled].
class AssessmentScanScreen extends StatelessWidget {
  const AssessmentScanScreen({super.key});
...
class _CameraFrame extends StatelessWidget {
  const _CameraFrame({required this.progress, this.compact = false});
